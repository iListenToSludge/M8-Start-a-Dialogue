...
@onready var action_buttons_vbox_container: VBoxContainer = $VBoxContainer/ActionButtonsVboxContainer
...
func create_buttons(choices_data: Dictionary) -> void:
	...
	for choice_text in choices_data:
		...
		var _target_line_indx: int = choices_data[choice_text]
		button.pressed.connect(show_text.bind(_target_line_indx))
